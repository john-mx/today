...
<p>Reserved campsites are checked with recreation.gov for availability every hour, so the available sites shown is pretty timely.</p>
...
<p>On any campground, the admin can set the number of open sites.  The reservation sites are checked frequently (hourly?). The number of open sites shown will be the most recent update, either manual or from recreation.gov. </p>
